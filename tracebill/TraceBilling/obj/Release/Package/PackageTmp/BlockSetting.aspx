<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="BlockSetting.aspx.cs" Inherits="TraceBilling.BlockSetting" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <legend class="w-auto">&nbsp;Block map Setup</legend>
           ...
           <asp:DropDownList ID="country_list" CssClass="form-control" runat="server"  OnDataBound="country_list_DataBound" Visible="true" AutoPostBack="True"
                 OnSelectedIndexChanged="country_list_SelectedIndexChanged" Width="493px">
                </asp:DropDownList>
                    </td>
                </tr>
                <tr>
