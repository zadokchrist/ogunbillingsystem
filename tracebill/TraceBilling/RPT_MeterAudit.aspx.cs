...
{
    public partial class RPT_MeterAudit : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (IsPostBack == false)
                {
                    ...
                    else
                    {
                        ...
                        ddlbranch.DataBind();
                        LoadDisplay();
                        bll.RecordAudittrail(Session["userName"].ToString(), "Accessed meter audit report");
        ...
        private void ex(DataTable dt)
        {
            ...
            string fileName = "filename=" + "MeterAuditReport.xls";
