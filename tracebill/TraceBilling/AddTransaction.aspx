	...
	<div class="row">
      ...
      <div id="transactiondisplay" runat="server">
            ...
            <table>
                ...
                <tr>
                    <td style="width: 502px"><label for="customerNumber">Customer Ref. Number</label>
          ...
          <div class="form-group col-xs-10 col-sm-6 col-md-6 col-lg-6">
           ...
           <asp:RadioButtonList ID="rtnpaymethod" runat="server" RepeatDirection="Horizontal" Width="80%"  AutoPostBack="true" OnSelectedIndexChanged="rtnpaymethod_SelectedIndexChanged">
            ...
            <asp:TextBox runat="server" CssClass="form-control" ID="txtcheque" placeholder="Enter check details"  Enabled="false"/>
                    </td>
                </tr>
                   <tr>
                    <td style="width: 502px">
